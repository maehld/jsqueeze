 ...
 * 
 * $Id: InfoTotalSongsCommand.java 66 2007-04-09 13:58:19Z dominikm $
 *******************************************************************************/
...
public class InfoTotalSongsCommand extends CLICommand {

	private int songCount;

	@Override
	protected void parseResponse(CLIData response) {
		songCount = Integer.parseInt(response.getParameters().get(0));
	}

	@Override
	protected void buildRequest(CLIData request) {
		request.setCommand("info total songs");
